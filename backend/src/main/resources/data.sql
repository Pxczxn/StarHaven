...
(1, '星河大床房', 399.00, 2, '大床', '含早', '宽敞舒适的星河主题大床房，配备观星天窗', '', 'enabled', NOW(), NOW()),
(2, '星空双床房', 369.00, 2, '双床', '不含早', '温馨的星空主题双床房，适合家庭入住', '', 'enabled', NOW(), NOW()),
(3, '星辰套房', 599.00, 4, '大床+沙发床', '含早', '豪华星辰主题套房，带客厅和厨房', '', 'enabled', NOW(), NOW())
...
(1, '101', '星河大床房-101', 1, '1F', 32.00, 2, 399.00, 'available', '', '独立卫浴,投影,浴缸,观星天窗,智能音响', '', NOW(), NOW()),
(2, '102', '星河大床房-102', 1, '1F', 32.00, 2, 399.00, 'available', '', '独立卫浴,投影,浴缸,观星天窗,智能音响', '', NOW(), NOW()),
(3, '201', '星空双床房-201', 2, '2F', 28.00, 2, 369.00, 'available', '', '独立卫浴,空调,电视,WiFi', '', NOW(), NOW()),
(4, '202', '星空双床房-202', 2, '2F', 28.00, 2, 369.00, 'available', '', '独立卫浴,空调,电视,WiFi', '', NOW(), NOW()),
(5, '203', '星空双床房-203', 2, '2F', 28.00, 2, 369.00, 'available', '', '独立卫浴,空调,电视,WiFi', '', NOW(), NOW()),
(6, '301', '星辰套房-301', 3, '3F', 65.00, 4, 599.00, 'available', '', '独立卫浴,客厅,厨房,投影,浴缸,阳台,智能家居', '', NOW(), NOW()),
(7, '302', '星辰套房-302', 3, '3F', 65.00, 4, 599.00, 'available', '', '独立卫浴,客厅,厨房,投影,浴缸,阳台,智能家居', '', NOW(), NOW())
ON DUPLICATE KEY UPDATE `name` = VALUES(`name`);
